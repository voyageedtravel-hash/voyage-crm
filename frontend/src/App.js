...
// ── DASHBOARD SCREEN ──────────────────────────────────────────────────────
  ...
  const PROP_GALLERY = {"kashmir":["https://images.unsplash.com/photo-1598091383021-15ddea10925d?w=700&q=80","https://images.unsplash.com/photo-1587474260584-136574528ed5?w=700&q=80"],
    ...
    "norway-finland":["https://images.unsplash.com/photo-1504233529578-6d46baba6d34?w=700&q=80","https://images.unsplash.com/photo-1505312917212-9db5bde78aff?w=700&q=80","https://images.unsplash.com/photo-1508592931388-95bc7b61033d?w=700&q=80"],"cruise":["https://images.unsplash.com/photo-1599640842225-85d111c60e6b?w=700&q=80","https://images.unsplash.com/photo-1548574505-5e239809ee19?w=700&q=80","https://images.unsplash.com/photo-1516495312540-a148643b22d3?w=700&q=80"],
  ...
  function buildProposalHTML(){
    ...
    const glimpseHTML=galleryImgs.length?`<div style="margin:0 0 18px">
      ...
      <div style="display:flex;gap:10px">${galleryImgs.map(g=>`<img src="${g}" onerror="this.style.display='none'" style="flex:1;min-width:0;height:130px;object-fit:cover;border-radius:14px"/>`).join("")}</div>
    </div>`:"";
    ...
    <div class="pagebreak" style="margin-top:26px">
      ...
      <div style="background:#fff;border:1px solid #e3eaf7;border-radius:14px;padding:16px 20px;font-size:10px;line-height:1.75;color:#4a5772">
        <b style="color:#0d1b3e">1. Parties & Agreement.</b> These Terms constitute a legally binding agreement between <b>Voyage-Ed Travels</b>, GMADA Aerocity, Mohali, Punjab, India ("the Company") and the client named in this proposal ("the Client"). Acceptance of this proposal — by digital acceptance below, written confirmation, or payment of any deposit — constitutes unconditional acceptance of these Terms.<br>
        <b style="color:#0d1b3e">2. Role of the Company.</b> The Company acts as an agent for airlines, hotels, cruise lines, transport providers and other third-party suppliers ("Suppliers"). All services are additionally subject to the Suppliers' own terms, tariffs and conditions of carriage.<br>
        <b style="color:#0d1b3e">3. Booking & Payment.</b> A non-refundable deposit of ₹20,000 per person (or the actual hotel, flight & land component minimum due, whichever is higher) is required to initiate a booking. Where the date of travel is less than 7 days away, a non-refundable deposit of 50% of the total cost applies. Full payment is required on confirmation of all services and before departure from India. Failure to pay by the due date entitles the Company to treat the booking as cancelled by the Client, with cancellation charges applying.<br>
        <b style="color:#0d1b3e">4. Cancellation & Refunds.</b> The Cancellation Policy stated in this proposal (${isCustomCancel?"the <u>special cancellation terms</u> specified above for this booking":"the standard slab: 30–16 days 50%, 15–8 days 75%, 7–0 days 100% of total cost"}) forms an integral part of this Agreement. Visa fees and service charges are non-refundable. No refund shall be payable, in whole or in part, for unused services. Travel insurance once issued is non-refundable. Refunds, where due, are processed only after receipt from the respective Suppliers and per their policies.<br>
        <b style="color:#0d1b3e">5. Amendments.</b> Any change requested by the Client is treated as a new booking, subject to availability and revised pricing; changes within the cancellation window attract applicable cancellation charges.<br>
        <b style="color:#0d1b3e">6. Travel Documents & Visas.</b> The Client is solely responsible for valid passports (minimum 6 months' validity from date of travel), visas, permits and health documentation. Photocopies of passport (first & address page) are mandatory. Visa grant/refusal/delay is at the sole discretion of the concerned Embassy/authority and is not the Company's liability; cancellation charges apply on visa refusal.<br>
        <b style="color:#0d1b3e">7. Pricing.</b> All prices are subject to availability, currency fluctuation, fuel surcharges and statutory taxes (incl. GST as per government norms) at the time of booking. Gala dinner supplements on special dates (24/31 Dec, 14 Feb) may be payable directly at the hotel.<br>
        <b style="color:#0d1b3e">8. Force Majeure & Liability.</b> The Company shall not be liable for delay, alteration, curtailment or cancellation arising from acts of God, weather, natural calamity, strikes, civil disturbance, government action, epidemic/pandemic, technical or operational failure of Suppliers, or any cause beyond its reasonable control; suitable alternatives will be arranged where possible, and additional costs so arising shall be borne by the Client. The Company's total liability under this Agreement shall in no event exceed the amount actually received by the Company for the booking.<br>
        <b style="color:#0d1b3e">9. Health & Insurance.</b> The Client is advised to obtain comprehensive travel insurance. The Client warrants fitness to travel and shall disclose any medical condition relevant to the services booked.<br>
        <b style="color:#0d1b3e">10. Conduct & Documentation.</b> The Company may decline or terminate services, without refund, in case of unlawful conduct or conduct endangering others. Check-in/check-out and baggage rules are as per the respective Suppliers.<br>
        <b style="color:#0d1b3e">11. Governing Law & Jurisdiction.</b> This Agreement is governed by the laws of India. All disputes shall be subject to the exclusive jurisdiction of the competent courts at Mohali / Chandigarh, Punjab, India, and shall first be attempted to be resolved amicably.<br>
        <b style="color:#0d1b3e">12. Entire Agreement.</b> This proposal together with these Terms constitutes the entire agreement and supersedes all prior communications relating to this booking.
      </div>
    </div>
    <div id="ve-accept" style="margin-top:16px;background:linear-gradient(135deg,#fdf9ee,#fff);border:2px solid #c9961a;border-radius:16px;padding:18px 22px">
      ...
      <div class="ve-interactive">
        <label style="display:flex;gap:10px;align-items:flex-start;font-size:12px;color:#33415e;cursor:pointer;line-height:1.6">
          ...
          <span>I, <b style="color:#0d1b3e">${esc(deal.clientName)||"the undersigned Client"}</b>, confirm that I have read, understood and unconditionally accept the Booking & Payment Policy, the Cancellation Policy${isCustomCancel?" (including the special cancellation terms specified for this booking)":""} and the Terms & Conditions of Service (Clauses 1–12) stated in this proposal (Ref: <b>${esc(ref)}</b>). I understand that my submission constitutes a legally binding acceptance of these terms.</span>
        </label>
      ...
      <div class="ve-printsign" style="display:none;font-size:11px;color:#33415e;line-height:2.4">
        I have read and accept the Booking Policy, Cancellation Policy and Terms & Conditions (Clauses 1–12) of this proposal.<br><br>
