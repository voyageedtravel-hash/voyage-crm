        ...
        {tab==="cancel"&&(
          <div style={{display:"flex",flexDirection:"column",gap:16}}>
            ...
            <div id="cxl-log" className="card" style={{borderColor:"#b91c1c"}}>
              ...
              <div style={{fontSize:11.5,color:"#6b7a99",marginBottom:12}}>Har component pe batao: kaun cancel hua, vendor ka kitna dooba, client se kitni penalty li, kitna refund diya — system baaki sab (cost, selling, profit) khud calculate kar dega.</div>
